...
namespace im.irrational.Google.OrTools.Examples.Test
{
    ...
    public class LinearOptimization
    {
        ...
        /// <summary>
        /// Example from https://developers.google.com/optimization/lp/stigler_diet
        /// 
        /// solving Stigler Diet Problem
        /// </summary>
        [TestMethod]
        public void StiglerDietProblem()
        {// Nutrient minimums.
            ...
            // assert
            Assert.AreEqual(77, solver.NumVariables());
            Assert.AreEqual(9, solver.NumConstraints());

            Assert.AreEqual(0.10866227820675686, objective.Value());
